        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <img src="https://via.placeholder.com/480x320?text=Main+Mockup" class="img-fluid rounded shadow" style="max-width:480px;" alt="Store preview">
                    <img src="https://via.placeholder.com/160x200?text=Card" class="position-absolute shadow-sm rounded" style="right:60px; top:-80px; width:160px;" alt="Feature card">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-md-4 text-center">
                    <img src="https://via.placeholder.com/300?text=Image" class="img-fluid mb-3 rounded" alt="Checkout feature">
                    <h5 class="fw-semibold">Fast, flexible checkout</h5>
                    <p>Convert more visitors with optimized checkout flow.</p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="https://via.placeholder.com/300?text=Image" class="img-fluid mb-3 rounded" alt="AI tools feature">
                    <h5 class="fw-semibold">Built-in AI tools</h5>
                    <p>Manage your store, marketing and inventory effortlessly.</p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="https://via.placeholder.com/300?text=Image" class="img-fluid mb-3 rounded" alt="Hosting feature">
        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 text-center">
                    <img src="https://via.placeholder.com/500x300?text=Feature+Image" class="img-fluid rounded shadow" alt="Online selling tools">
                </div>
            </div>
            ...
            <div class="row align-items-center flex-lg-row-reverse">
                ...
                <div class="col-lg-6 text-center">
                    <img src="https://via.placeholder.com/500x300?text=Feature+Image" class="img-fluid rounded shadow" alt="Omnichannel reach">
                </div>
            </div>
        </div>
    </section>
