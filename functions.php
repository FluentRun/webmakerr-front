...
// Keep plugin/core admin notices hidden without deregistering hooks to avoid slowing
// down the admin or breaking script registrations. We simply hide them with CSS.
add_action( 'admin_head', 'wmf_hide_admin_notices_css' );

function wmf_hide_admin_notices_css() {
